...
//	FGameplayTag State_AnimStyle_Staff1H; // "State.AnimStyle.Staff1H"
//
//	// =========================================================
...
public:
	...
	FGameplayTag Damage_Type_Heavy;
	FGameplayTag Damage_Source_Melee;
	FGameplayTag Damage_Source_Skill;
	...
	FGameplayTag Slot_Weapon_Sub;
	FGameplayTag Slot_Armor_Head;
	FGameplayTag Slot_Armor_Chest;
	...
	// Weapon.*
	FGameplayTag Weapon_Sword_OneHand;
	FGameplayTag Weapon_Staff_OneHand;
	FGameplayTag Weapon_Staff_TwoHand;

	// State.AnimStyle.*
	FGameplayTag State_AnimStyle_Unarmed;
	FGameplayTag State_AnimStyle_Sword1H;
	FGameplayTag State_AnimStyle_Staff1H;
