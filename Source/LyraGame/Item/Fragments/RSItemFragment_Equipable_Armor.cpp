#include "RSItemFragment_Equipable_Armor.h"

#include "Item/RSItemInstance.h"
#include "UObject/ObjectSaveContext.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(RSItemFragment_Equipable_Armor)

URSItemFragment_Equipable_Armor::URSItemFragment_Equipable_Armor(const FObjectInitializer& ObjectInitializer)
...
void URSItemFragment_Equipable_Armor::PreSave(FObjectPreSaveContext SaveContext)
{
...
void URSItemFragment_Equipable_Armor::OnInstanceCreated(URSItemInstance* ItemInstance) const
{
