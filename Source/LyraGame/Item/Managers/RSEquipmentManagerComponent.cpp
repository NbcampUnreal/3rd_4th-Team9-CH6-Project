...
//}
//
//int32 URSEquipmentManagerComponent::CanMoveOrMergeEquipment(URSEquipmentManagerComponent* OtherComponent, EEquipmentSlotType FromEquipmentSlotType, EEquipmentSlotType ToEquipmentSlotType) const
//{
...
//}
//
//int32 URSEquipmentManagerComponent::CanMoveOrMergeEquipment(URSInventoryManagerComponent* OtherComponent, const FIntPoint& FromItemSlotPos, EEquipmentSlotType ToEquipmentSlotType) const
//{
//	if (OtherComponent == nullptr)
//		return 0;
//
...
//}
//
//int32 URSEquipmentManagerComponent::CanMoveOrMergeEquipment_Quick(URSEquipmentManagerComponent* OtherComponent, EEquipmentSlotType FromEquipmentSlotType, EEquipmentSlotType& OutToEquipmentSlotType) const
//{
...
//}
//
//int32 URSEquipmentManagerComponent::CanMoveOrMergeEquipment_Quick(URSInventoryManagerComponent* OtherComponent, const FIntPoint& FromItemSlotPos, EEquipmentSlotType& OutToEquipmentSlotType) const
//{
//	OutToEquipmentSlotType = EEquipmentSlotType::Count;
//	
//	if (OtherComponent == nullptr)
...
//}
//
//int32 URSEquipmentManagerComponent::CanMoveOrMergeEquipment_Quick(int32 FromItemTemplateID, EItemRarity FromItemRarity, int32 FromItemCount, EEquipmentSlotType& OutToEquipmentSlotType) const
//{
//	OutToEquipmentSlotType = EEquipmentSlotType::Count;
//
...
//		return 0;
//
//	const URSItemTemplate& FromItemTemplate = URSItemData::Get().FindItemTemplateByID(FromItemTemplateID);
//	const URSItemFragment_Equipable* FromEquippableFragment = FromItemTemplate.FindFragmentByClass<URSItemFragment_Equipable>();
...
//		{
//			EEquipmentSlotType ToEquipmentSlotType = URSEquipManagerComponent::ConvertToEquipmentSlotType(FromWeaponFragment->WeaponHandType, (EWeaponSlotType)i);
...
//
//		EEquipmentSlotType ToEquipmentSlotType = URSEquipManagerComponent::ConvertToEquipmentSlotType(FromArmorFragment->ArmorType);
//		int32 MovableCount = CanAddEquipment(FromItemTemplateID, FromItemRarity, FromItemCount, ToEquipmentSlotType);
//		if (MovableCount > 0)
//		{
//			OutToEquipmentSlotType = ToEquipmentSlotType;
...
//		{
//			EEquipmentSlotType ToEquipmentSlotType = URSEquipManagerComponent::ConvertToEquipmentSlotType((EUtilitySlotType)i);
//			URSItemInstance* ToItemInstance = GetItemInstance(ToEquipmentSlotType);
...
//				const URSItemTemplate& ToItemTemplate = URSItemData::Get().FindItemTemplateByID(ToItemInstance->GetItemTemplateID());
...
//}
//
//bool URSEquipmentManagerComponent::CanSwapEquipment(URSEquipmentManagerComponent* OtherComponent, EEquipmentSlotType FromEquipmentSlotType, EEquipmentSlotType ToEquipmentSlotType) const
//{
//	if (OtherComponent == nullptr || FromEquipmentSlotType == EEquipmentSlotType::Count)
//		return false;
//
//	const TArray<FRSEquipmentEntry>& FromEntries = OtherComponent->GetAllEntries();
//	const FRSEquipmentEntry& FromEntry = FromEntries[(int32)FromEquipmentSlotType];
//	URSItemInstance* FromItemInstance = FromEntry.GetItemInstance();
//
//	if (FromItemInstance == nullptr)
//		return false;
//
//	const URSItemFragment_Equipable* FromEquippableFragment = FromItemInstance->FindFragmentByClass<URSItemFragment_Equipable>();
//	if (FromEquippableFragment == nullptr)
//		return false;
//
//	if (this == OtherComponent && FromEquipmentSlotType == ToEquipmentSlotType)
...
//}
//
//bool URSEquipmentManagerComponent::CanSwapEquipment(URSInventoryManagerComponent* OtherComponent, const FIntPoint& FromItemSlotPos, EEquipmentSlotType ToEquipmentSlotType, FIntPoint& OutToItemSlotPos)
//{
//	if (OtherComponent == nullptr)
//		return false;
//
...
//		return false;
//	
//	URSItemInstance* FromItemInstance = OtherComponent->GetItemInstance(FromItemSlotPos);
//	if (FromItemInstance == nullptr)
//		return false;
//
//	const URSItemInstance* ToItemInstance = GetItemInstance(ToEquipmentSlotType);
...
//	{
//		const URSItemFragment_Equipable_Armor* FromArmorFragment = Cast<URSItemFragment_Equipable_Armor>(FromEquippableFragment);
//		EEquipmentSlotType FromEquipmentSlotType = URSEquipManagerComponent::ConvertToEquipmentSlotType(FromArmorFragment->ArmorType);
//
//		if (FromEquipmentSlotType != ToEquipmentSlotType)
//			return false;
//	}
...
//}
//
//bool URSEquipmentManagerComponent::CanSwapEquipment_Quick(URSEquipmentManagerComponent* OtherComponent, EEquipmentSlotType FromEquipmentSlotType, EEquipmentSlotType& OutToEquipmentSlotType) const
//{
//	OutToEquipmentSlotType = EEquipmentSlotType::Count;
//	
//	if (OtherComponent == nullptr)
...
//		return false;
//	
//	URSItemInstance* FromItemInstance = OtherComponent->GetItemInstance(FromEquipmentSlotType);
//	if (FromItemInstance == nullptr)
//		return false;
//
//	const URSItemFragment_Equipable* FromEquippableFragment = FromItemInstance->FindFragmentByClass<URSItemFragment_Equipable>();
...
//}
//
//bool URSEquipmentManagerComponent::CanSwapEquipment_Quick(URSInventoryManagerComponent* OtherComponent, const FIntPoint& FromItemSlotPos, EEquipmentSlotType& OutToEquipmentSlotType, FIntPoint& OutToItemSlotPos)
//{
//	OutToEquipmentSlotType = EEquipmentSlotType::Count;
//	
//	if (OtherComponent == nullptr)
...
//		return false;
//	
//	const URSItemInstance* ToItemInstance = nullptr;
//
//	if (FromEquippableFragment->EquipmentType == EEquipmentType::Weapon)
//	{
//		const URSItemFragment_Equipable_Weapon* FromWeaponFragment = Cast<URSItemFragment_Equipable_Weapon>(FromEquippableFragment);
...
//	{
//		const URSItemFragment_Equipable_Armor* FromArmorFragment = Cast<URSItemFragment_Equipable_Armor>(FromEquippableFragment);
//		OutToEquipmentSlotType = URSEquipManagerComponent::ConvertToEquipmentSlotType(FromArmorFragment->ArmorType);
//
