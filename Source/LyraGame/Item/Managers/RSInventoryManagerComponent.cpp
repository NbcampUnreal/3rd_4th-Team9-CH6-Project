...
//
//URSItemInstance* FRSInventoryEntry::Init(int32 InItemTemplateID, int32 InItemCount, EItemRarity InItemRarity)
//{
//	check(InItemTemplateID > 0 && InItemCount > 0 && InItemRarity != EItemRarity::Count);
//	
//	URSItemInstance* NewItemInstance = NewObject<URSItemInstance>();
...
//}
//
//void FRSInventoryEntry::Init(URSItemInstance* InItemInstance, int32 InItemCount)
//{
...
//}
//
//URSItemInstance* FRSInventoryEntry::Reset()
//{
...
//}
//
//bool FRSInventoryList::NetDeltaSerialize(FNetDeltaSerializeInfo& DeltaParams)
//{
//	return FFastArraySerializer::FastArrayDeltaSerialize<FRSInventoryEntry, FRSInventoryList>(Entries, DeltaParams, *this);
//}
//
//void FRSInventoryList::PostReplicatedAdd(const TArrayView<int32> AddedIndices, int32 FinalSize)
//{
//	const FIntPoint& InventorySlotCount = InventoryManager->GetInventorySlotCount();
//
//	for (int32 AddedIndex : AddedIndices)
//	{
//		FRSInventoryEntry& Entry = Entries[AddedIndex];
...
//}
//
//void FRSInventoryList::PostReplicatedChange(const TArrayView<int32> ChangedIndices, int32 FinalSize)
//{
...
//	{
//		FRSInventoryEntry& Entry = Entries[ChangedIndex];
//		if (Entry.ItemInstance)
//		{
...
//}
//
//void FRSInventoryList::BroadcastChangedMessage(const FIntPoint& ItemSlotPos, URSItemInstance* ItemInstance, int32 ItemCount)
//{
...
//}
//
//URSInventoryManagerComponent::URSInventoryManagerComponent(const FObjectInitializer& ObjectInitializer)
...
//}
//
//void URSInventoryManagerComponent::InitializeComponent()
//{
//	Super::InitializeComponent();
//
//	if (GetOwner() && GetOwner()->HasAuthority())
//	{
//		TArray<FRSInventoryEntry>& Entries = InventoryList.Entries;
//		Entries.SetNum(InventorySlotCount.X * InventorySlotCount.Y);
//	
//		for (FRSInventoryEntry& Entry : Entries)
//		{
...
//}
//
//void URSInventoryManagerComponent::GetLifetimeReplicatedProps(TArray<FLifetimeProperty>& OutLifetimeProps) const
//{
...
//}
//
//bool URSInventoryManagerComponent::ReplicateSubobjects(UActorChannel* Channel, FOutBunch* Bunch, FReplicationFlags* RepFlags)
//{
//	bool bWroteSomething = Super::ReplicateSubobjects(Channel, Bunch, RepFlags);
//	
//	for (FRSInventoryEntry& Entry : InventoryList.Entries)
//	{
...
//}
//
//void URSInventoryManagerComponent::ReadyForReplication()
//{
//	Super::ReadyForReplication();
//	
//	if (IsUsingRegisteredSubObjectList())
//	{
//		for (const FRSInventoryEntry& Entry : InventoryList.Entries)
//		{
...
//}
//
//int32 URSInventoryManagerComponent::CanMoveOrMergeItem(URSInventoryManagerComponent* OtherComponent, const FIntPoint& FromItemSlotPos, const FIntPoint& ToItemSlotPos) const
//{
...
//		return 0;
//	
//	const URSItemInstance* FromItemInstance = OtherComponent->GetItemInstance(FromItemSlotPos);
...
//		return 0;
//	
//	const URSItemInstance* ToItemInstance = GetItemInstance(ToItemSlotPos);
//	const int32 ToItemCount = GetItemCount(ToItemSlotPos);
//	
//	const int32 FromTemplateID = FromItemInstance->GetItemTemplateID();
//	const URSItemTemplate& FromItemTemplate = URSItemData::Get().FindItemTemplateByID(FromTemplateID);
//	
//	if (ToItemInstance)
//	{
...
//}
//
//int32 URSInventoryManagerComponent::CanMoveOrMergeItem(URSEquipmentManagerComponent* OtherComponent, EEquipmentSlotType FromEquipmentSlotType, const FIntPoint& ToItemSlotPos) const
//{
//	if (OtherComponent == nullptr)
//		return 0;
//
...
//		return 0;
//	
//	const URSItemInstance* FromItemInstance = OtherComponent->GetItemInstance(FromEquipmentSlotType);
...
//}
//
//int32 URSInventoryManagerComponent::CanMoveOrMergeItem_Quick(URSInventoryManagerComponent* OtherComponent, const FIntPoint& FromItemSlotPos, TArray<FIntPoint>& OutToItemSlotPoses, TArray<int32>& OutToItemCounts) const
//{
...
//}
//
//int32 URSInventoryManagerComponent::CanMoveOrMergeItem_Quick(URSEquipmentManagerComponent* OtherComponent, EEquipmentSlotType FromEquipmentSlotType, TArray<FIntPoint>& OutToItemSlotPoses, TArray<int32>& OutToItemCounts) const
//{
//	OutToItemSlotPoses.Reset();
//	OutToItemCounts.Reset();
//	
...
//}
//
//int32 URSInventoryManagerComponent::CanAddItem(int32 ItemTemplateID, EItemRarity ItemRarity, int32 ItemCount, TArray<FIntPoint>& OutToItemSlotPoses, TArray<int32>& OutToItemCounts) const
//{
//	OutToItemSlotPoses.Reset();
//	OutToItemCounts.Reset();
//	
...
//	{
//		const TArray<FRSInventoryEntry>& ToEntries = GetAllEntries();
//		
//		for (int32 i = 0; i < ToEntries.Num(); i++)
//		{
//			const FRSInventoryEntry& ToEntry = ToEntries[i];
//			const URSItemInstance* ToItemInstance = ToEntry.GetItemInstance();
...
//}
//
//bool URSInventoryManagerComponent::CanRemoveItem(int32 ItemTemplateID, int32 ItemCount, TArray<FIntPoint>& OutToItemSlotPoses, TArray<int32>& OutToItemCounts) const
//{
//	OutToItemSlotPoses.Reset();
//	OutToItemCounts.Reset();
//
...
//
//	const TArray<FRSInventoryEntry>& Entries = GetAllEntries();
//	
//	for (int32 i = Entries.Num() - 1; i >= 0; i--)
//	{
//		const FRSInventoryEntry& ToEntry = Entries[i];
...
//}
//
//int32 URSInventoryManagerComponent::TryAddItemByRarity(TSubclassOf<URSItemTemplate> ItemTemplateClass, EItemRarity ItemRarity, int32 ItemCount)
//{
...
//		return 0;
//	
//	int32 ItemTemplateID = URSItemData::Get().FindItemTemplateIDByClass(ItemTemplateClass);
//	const URSItemTemplate& ItemTemplate = URSItemData::Get().FindItemTemplateByID(ItemTemplateID);
//	
//	TArray<FIntPoint> ToItemSlotPoses;
//	TArray<int32> ToItemCounts;
...
//	{
//		TArray<URSItemInstance*> AddedItemInstances;
//		
...
//			FRSInventoryEntry& ToEntry = InventoryList.Entries[ToIndex];
//
...
//		{
//			for (URSItemInstance* AddedItemInstance : AddedItemInstances)
//			{
...
//}
//
//int32 URSInventoryManagerComponent::TryAddItemByProbability(TSubclassOf<URSItemTemplate> ItemTemplateClass, int32 ItemCount, const TArray<FRSItemRarityProbability>& ItemProbabilities)
//{
//	check(GetOwner()->HasAuthority());
//
//	return TryAddItemByRarity(ItemTemplateClass, URSItemInstance::DetermineItemRarity(ItemProbabilities), ItemCount);
//}
//
//bool URSInventoryManagerComponent::TryRemoveItem(int32 ItemTemplateID, int32 ItemCount)
//{
//	check(GetOwner()->HasAuthority());
//
//	if (ItemTemplateID <= 0 || ItemCount <= 0)
...
//	{
//		TArray<URSItemInstance*> RemovedItemInstances;
//
//		for (int32 i = 0; i < ToItemSlotPoses.Num(); i++)
//		{
//			const FIntPoint& ToItemSlotPos = ToItemSlotPoses[i];
...
//		if (IsUsingRegisteredSubObjectList())
//		{
//			for (URSItemInstance* RemovedItemInstance : RemovedItemInstances)
//			{
...
//}
//
//void URSInventoryManagerComponent::AddItem_Unsafe(const FIntPoint& ItemSlotPos, URSItemInstance* ItemInstance, int32 ItemCount)
//{
//	check(GetOwner()->HasAuthority());
//	
//	const int32 Index = ItemSlotPos.Y * InventorySlotCount.X + ItemSlotPos.X;
//	FRSInventoryEntry& Entry = InventoryList.Entries[Index];
//	
...
//}
//
//URSItemInstance* URSInventoryManagerComponent::RemoveItem_Unsafe(const FIntPoint& ItemSlotPos, int32 ItemCount)
//{
//	check(GetOwner()->HasAuthority());
//	
//	const int32 Index = ItemSlotPos.Y * InventorySlotCount.X + ItemSlotPos.X;
...
//}
//
//void URSInventoryManagerComponent::MarkSlotChecks(TArray<bool>& InSlotChecks, bool bIsUsing, const FIntPoint& ItemSlotPos, const FIntPoint& ItemSlotCount) const
//{
...
//}
//
//void URSInventoryManagerComponent::MarkSlotChecks(bool bIsUsing, const FIntPoint& ItemSlotPos, const FIntPoint& ItemSlotCount)
//{
//	MarkSlotChecks(SlotChecks, bIsUsing, ItemSlotPos, ItemSlotCount);
//}
//
//bool URSInventoryManagerComponent::IsEmpty(const TArray<bool>& InSlotChecks, const FIntPoint& ItemSlotPos, const FIntPoint& ItemSlotCount) const
//{
//	if (ItemSlotPos.X < 0 || ItemSlotPos.Y < 0)
//		return false;
//
...
//}
//
//bool URSInventoryManagerComponent::IsEmpty(const FIntPoint& ItemSlotPos, const FIntPoint& ItemSlotCount) const
//{
//	return IsEmpty(SlotChecks, ItemSlotPos, ItemSlotCount);
//}
//
//bool URSInventoryManagerComponent::IsAllEmpty()
//{
//	for (FRSInventoryEntry& Entry : InventoryList.Entries)
//	{
//		if (Entry.GetItemInstance())
...
//}
//
//URSItemInstance* URSInventoryManagerComponent::GetItemInstance(const FIntPoint& ItemSlotPos) const
//{
//	if (ItemSlotPos.X < 0 || ItemSlotPos.Y < 0 || ItemSlotPos.X >= InventorySlotCount.X || ItemSlotPos.Y >= InventorySlotCount.Y)
//		return nullptr;
//	
//	const TArray<FRSInventoryEntry>& Entries = InventoryList.GetAllEntries();
//	const int32 EntryIndex = ItemSlotPos.Y * InventorySlotCount.X + ItemSlotPos.X;
//	const FRSInventoryEntry& Entry = Entries[EntryIndex];
//	
//	return Entry.GetItemInstance();
//}
//
//int32 URSInventoryManagerComponent::GetItemCount(const FIntPoint& ItemSlotPos) const
//{
//	if (ItemSlotPos.X < 0 || ItemSlotPos.Y < 0 || ItemSlotPos.X >= InventorySlotCount.X || ItemSlotPos.Y >= InventorySlotCount.Y)
//		return 0;
//	
...
//}
//
//const TArray<FRSInventoryEntry>& URSInventoryManagerComponent::GetAllEntries() const
//{
//	return InventoryList.GetAllEntries();
//}
//
//int32 URSInventoryManagerComponent::GetTotalCountByID(int32 ItemTemplateID) const
//{
//	int32 TotalCount = 0;
//	
//	for (const FRSInventoryEntry& Entry : GetAllEntries())
//	{
