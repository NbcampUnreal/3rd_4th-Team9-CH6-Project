...
#include "RSSkillIconWidget.generated.h"
...
UCLASS()
class URSSkillIconWidget : public UUserWidget
{
	GENERATED_BODY()
	
public:
	URSSkillIconWidget(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
