#include "RSSkillProgressWidget.h"
...
#include UE_INLINE_GENERATED_CPP_BY_NAME(RSSkillProgressWidget)

URSSkillProgressWidget::URSSkillProgressWidget(const FObjectInitializer& ObjectInitializer)
	: Super(ObjectInitializer)
{
    
}

void URSSkillProgressWidget::NativeConstruct()
{
...
void URSSkillProgressWidget::NativeDestruct()
{
	UGameplayMessageSubsystem& MessageSubsystem = UGameplayMessageSubsystem::Get(this);
...
void URSSkillProgressWidget::NativeTick(const FGeometry& MyGeometry, float InDeltaTime)
{
...
void URSSkillProgressWidget::ConstructUI(FGameplayTag Channel, const FSkillProgressInitializeMessage& Message)
{
...
void URSSkillProgressWidget::RefreshUI(FGameplayTag Channel, const FSkillProgressRefreshMessage& Message)
{
	if (GetVisibility() == ESlateVisibility::Visible)
	{
		ProgressBar_SkillProgress->SetFillColorAndOpacity(Message.PhaseColor);
