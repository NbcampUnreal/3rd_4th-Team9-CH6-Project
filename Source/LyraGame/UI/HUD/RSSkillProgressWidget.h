...
#include "RSSkillProgressWidget.generated.h"
...
UCLASS()
class URSSkillProgressWidget : public UUserWidget
{
	GENERATED_BODY()
	
public:
	URSSkillProgressWidget(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
