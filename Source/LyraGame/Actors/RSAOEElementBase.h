//#pragma once
//
//#include "RSAOEElementBase.generated.h"
//
...
//
//UCLASS()
//class ARSAOEElementBase : public AActor
//{
//	GENERATED_BODY()
//	
//public:
//	ARSAOEElementBase(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
//
//protected:
...
//
//protected:
//	UPROPERTY(EditDefaultsOnly, Category="RS|AOE Element")
//	float Damage = 40.f;
//
//	UPROPERTY(EditDefaultsOnly, Category="RS|AOE Element")
...
//	
//	UPROPERTY(EditDefaultsOnly, Category="RS|AOE Element", meta=(EditCondition="ElementType == EAOEElementType::Projectile", EditConditionHides))
