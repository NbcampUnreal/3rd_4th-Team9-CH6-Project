...
//
//#include UE_INLINE_GENERATED_CPP_BY_NAME(RSAOEElementBase)
//
//ARSAOEElementBase::ARSAOEElementBase(const FObjectInitializer& ObjectInitializer)
...
//}
//
//void ARSAOEElementBase::BeginPlay()
//{
//	Super::BeginPlay();
//	
...
//}
//
//void ARSAOEElementBase::OnTimelineTick(float Value)
//{
...
//}
//
//void ARSAOEElementBase::OnTimelineFinished()
//{
//	CollisionComponent->Deactivate();
//	NiagaraComponent->Deactivate();
//	
...
//}
//
//bool ARSAOEElementBase::PerformTrace(const FVector& StartLocation, const FVector& EndLocation, TArray<FHitResult>& OutHitResults)
//{
...
//}
//
//void ARSAOEElementBase::HandleCollisionDetection(const FHitResult& HitResult)
//{
...
//	DamageEffectSpecHandle.Data->SetSetByCallerMagnitude(RSGameplayTags::SetByCaller_BaseDamage, Damage);
...
//	SourceASC->ExecuteGameplayCue(RSGameplayTags::GameplayCue_Weapon_Impact, SourceCueParams);
//
//	if (AdditionalEffect)
//	{
